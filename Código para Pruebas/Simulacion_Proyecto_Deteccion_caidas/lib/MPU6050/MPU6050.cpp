...
void MPU6050::leer_sensor(){
    ...
    acelerometro_x = (acelerometro_x - offset_acelerometro_x)/SENSIBILIDAD_ACELEROMETRO;
    acelerometro_y = (acelerometro_y - offset_acelerometro_y)/SENSIBILIDAD_ACELEROMETRO;
    acelerometro_z = (acelerometro_z - offset_acelerometro_z)/SENSIBILIDAD_ACELEROMETRO;
    giroscopio_x = (giroscopio_x - offset_giroscopio_x)/SENSIBILIDAD_GIROSCOPIO;
    giroscopio_y = (giroscopio_y - offset_giroscopio_y)/SENSIBILIDAD_GIROSCOPIO;
    giroscopio_z = (giroscopio_z - offset_giroscopio_z)/SENSIBILIDAD_GIROSCOPIO;
}
